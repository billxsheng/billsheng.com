    ...
    render() {
        return(
            <div styleName="about" className="container">
                ...
                <ProjectTile to="/projects/skout" reverse="true"  imageHeight="400px" imageName="projects/ryse.png" tag="Hackathon" title="Ryse" shortDesc="Networking application for ex-criminals." />
                <ProjectTile to="/skout" top="25px" imageHeight="400px" imageName="projects/Canadian-Tire.png" tag="Internship" title="Canadian Tire" shortDesc="First Internship"/>
                <ProjectTile to="/skout" reverse="true" imageHeight="400px" imageName="projects/blitz.png" tag="Project" title="Blitz" shortDesc="Sports Notification Innovation"/>
                <ProjectTile to="/skout" imageHeight="400px" imageName="projects/munkee.png" tag="Project" title="Munkee" shortDesc="Just for fun"/>
