    ...
    render() {
        return(
            <div className="container">
                ...
                <div className="row">
                    <ProjectTile to="/projects/experience/opentext" imageName = "projects/ot.png" imageHeight="400px"  tag={projectsInfo.opentext.tag} title={projectsInfo.opentext.name} shortDesc={projectsInfo.opentext.description} />
                </div>
                <div className="row">
                    <ProjectTile to="/projects/experience/freelance" imageHeight="400px" reverse="true" imageName="projects/freelance.png" tag={projectsInfo.freelance.tag} title={projectsInfo.freelance.name} shortDesc={projectsInfo.freelance.description} />
                </div>
                <div className="row">
