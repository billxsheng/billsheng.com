    ...
    render() {
        return(
            <div className="container">
                ...
                <div className="row">
                    <ProjectTile to="/projects/experience/freelance" singleTile = "true" tag={projectsInfo.freelance.tag} title={projectsInfo.freelance.name} shortDesc={projectsInfo.freelance.description} />
                </div>
                <div className="row">
