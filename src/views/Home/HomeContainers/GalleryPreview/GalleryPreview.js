                    ...
                    <span className="container">
                        ...
                        <div styleName="carousel-wrapper-btn"  >
                            <OwlCarousel style={carouselStyle} ref="projCarousel" options={options}>   
                                <GalleryPreviewTile background = "../../../../../assets/images/logo.png" date="Sept 5" title="The Rise of the FBS" desc="The NFL's successor" />
                                <GalleryPreviewTile title="GraphQL" desc="Seamless API manipulation" date="Sept 5" />
                                <GalleryPreviewTile title="Co-op #1" desc="Thoughts and Reflections" date="Sept 5" />
                            </OwlCarousel>
