                ...
                <span className="container">
                    ...
                    <span styleName="gallery-preview-paragraph" className="container">
                        <p>From pick six to python.</p>            
                            ...
                            <SlideCarousel>
                                <CarouselItem path = "gallery/fbs.jpeg" date={GalleryInfo.saturdayNightLights.date} title={GalleryInfo.saturdayNightLights.title}  />
                                <CarouselItem  path = "gallery/graphql.jpg"  title={GalleryInfo.graphQL.title} date={GalleryInfo.graphQL.date} />
                                <CarouselItem  path = "gallery/coop1.jpg"  title={GalleryInfo.firstInternship.title}  date={GalleryInfo.firstInternship.date} />
                            </SlideCarousel>
