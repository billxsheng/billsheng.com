const ProjectsInfo = {
    ...
    huddle: {
        ...
        content: {
            ...
            nextSteps : 'Huddle is currently based on the NFL. It can easily be extended into other sports leagues such as the NBA. At the moment, only a mobile client exists for Huddle. Since a backend already exists, making Huddle work on the web would be a simple frontend extension'
        }  
    },
    airdrums: {
        name:'AirDrums',
